    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-heading text-2xl font-semibold">Create Account</CardTitle>
          <p className="text-sm text-muted-foreground">
            Join CLOTHING-X for early access to drops and exclusive offers.
          </p>
        </CardHeader>
        <CardContent>
          <Button
          ...
          <form onSubmit={signUp} className="space-y-4">
            <div>
              <Label htmlFor="name" className="mb-1.5 block text-xs uppercase tracking-wider">Full Name</Label>
              <Input
                id="name"
                value={name}
    ...
    >
      {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
          ...
          <div className="mt-4 text-center">
            <Link href="/" className="text-xs uppercase tracking-wider text-muted-foreground hover:text-foreground">
              ← Back to store
            </Link>
          </div>
        </CardContent>
